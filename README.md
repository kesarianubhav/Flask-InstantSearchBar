...
=> Pandas ( >0.20   , Just for loading the csv , I could have done it with the traditional open function also , but then it would have become too slow . Other than that there is no use of pandas in the logic or the app.)
